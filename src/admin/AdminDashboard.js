...
const styles = StyleSheet.create({
  ...
  pageTitle: { fontSize: 22, fontWeight: '900', color: '#D4AF37', textAlign: 'center', marginBottom: 20, marginTop: 10 },
  sectionHeader: { fontSize: 15, fontWeight: '700', color: '#F9E596', marginTop: 20, marginBottom: 10, borderLeftWidth: 3, borderLeftColor: '#D4AF37', paddingLeft: 10 },
