...
const styles = StyleSheet.create({
  ...
  tabRow: { flexDirection: 'row', marginHorizontal: 10, marginBottom: 6, backgroundColor: '#350A0A', borderRadius: 8, padding: 2 },
  tab: { flex: 1, paddingVertical: 4, borderRadius: 6, alignItems: 'center' },
  tabActive: { backgroundColor: '#D4AF37' },
  tabText: { color: '#A07855', fontWeight: '700', fontSize: 13 },
  tabTextActive: { color: '#1E0505' },
  scrollContent: { paddingHorizontal: 10, paddingBottom: 30 },
  sectionDesc: { color: '#A07855', fontSize: 11, marginBottom: 8, lineHeight: 16 },
  configCard: { backgroundColor: '#350A0A', borderRadius: 12, borderWidth: 1, borderColor: '#5A2A2A', padding: 12, marginBottom: 8, flexDirection: 'row', alignItems: 'center' },
