...
const styles = StyleSheet.create({
  ...
  filterTab: { flex: 1, paddingVertical: 7, borderRadius: 8, backgroundColor: '#350A0A', borderWidth: 1, borderColor: '#5A2A2A', alignItems: 'center' },
  ...
  typeRow: { flexDirection: 'row', marginHorizontal: 16, marginBottom: 8, gap: 8 },
  typeTab: { flex: 1, paddingVertical: 6, borderRadius: 8, backgroundColor: '#350A0A', borderWidth: 1, borderColor: '#5A2A2A', alignItems: 'center' },
  ...
  summary: { color: '#A07855', fontSize: 12, marginHorizontal: 16, marginBottom: 8 },
  card: { backgroundColor: '#350A0A', borderRadius: 12, borderWidth: 1, borderColor: '#5A2A2A', marginHorizontal: 16, marginBottom: 10, padding: 14 },
